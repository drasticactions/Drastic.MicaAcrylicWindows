// <copyright file="BaseWindow.cs" company="Drastic Actions">
...
namespace Drastic.UI.Xaml
{
    ...
    public class BaseWindow : Window
    {
        ...
        public BaseWindow(ISystemBackdropControllerWithTargets controller, SystemBackdropConfiguration? config = default)
        {
